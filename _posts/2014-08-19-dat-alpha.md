---
layout: post
title: 'Announcing the dat Stable Alpha'
author: maxogden
---

*The following is [an announcement from the dat project](https://github.com/maxogden/dat/blob/master/docs/dat-stable-alpha.md), reposted here.*
